...
export function CategoriesView({
  ...
  const [isCategoriesExpanded, setIsCategoriesExpanded] = useState(() => {
    const saved = localStorage.getItem('isCategoriesExpanded');
    return saved !== null ? saved === 'true' : true;
  });
  const [isRecurringExpanded, setIsRecurringExpanded] = useState(() => {
    const saved = localStorage.getItem('isRecurringExpanded');
    return saved !== null ? saved === 'true' : true;
  });
  ...
  React.useEffect(() => {
    localStorage.setItem('isCategoriesExpanded', String(isCategoriesExpanded));
  }, [isCategoriesExpanded]);

  React.useEffect(() => {
    localStorage.setItem('isRecurringExpanded', String(isRecurringExpanded));
  }, [isRecurringExpanded]);
